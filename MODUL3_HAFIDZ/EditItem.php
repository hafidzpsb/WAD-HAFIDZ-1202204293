...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="d-flex justify-content-left container-fluid">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="/MODUL3_HAFIDZ/AddItem.php">MyCar</a></li>
            </ul>
        </div>
    </nav>
    <?php
    ...
    <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
        ...
        <form action="MODUL3_HAFIDZ/update.php?id=<?php echo $selects['id_mobil']?>" method="POST" enctype='multipart/form-data'>
            <div class="mb-3">
